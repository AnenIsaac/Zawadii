...
export function CustomersDetailTable({
  ...
  return (
    <>
            ...
            {customers.length > 0 ? (
              customers.map((customer, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell>
                    <Button
                      variant={customer.tag === "Active" ? "secondary" : "outline"}
                      size="sm"
                      className={
                        customer.tag === "Send Promotion" ? "text-orange-500 border-orange-300 hover:bg-orange-50" : ""
                      }
                      onClick={() => customer.tag === "Send Promotion" && handleSendMessage(customer)}
                    >
                      {customer.tag}
                    </Button>
                  </TableCell>
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem onClick={handleSendBulkMessage}>Send Bulk Message</DropdownMenuItem>
      ...
      <SendMessageModal open={messageModalOpen} onOpenChange={setMessageModalOpen} customer={selectedCustomer} />
